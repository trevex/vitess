...
type Shard struct {
	...
	// reparent_time_ns is set during a reparent operation
	// and is the time a reparent on this shard started.
	// If the value is 0 there is no ongoing reparent.
	ReparentTimeNs int64 `protobuf:"varint,7,opt,name=reparent_time_ns,json=reparentTimeNs" json:"reparent_time_ns,omitempty"`
}
...
func (m *Shard) GetReparentTimeNs() int64 {
	if m != nil {
		return m.ReparentTimeNs
	}
	return 0
}
...
var fileDescriptor0 = []byte{
	...
	,
}

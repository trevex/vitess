...
_SHARD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reparent_time_ns', full_name='topodata.Shard.reparent_time_ns', index=6,
